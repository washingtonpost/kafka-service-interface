...
public class ConfigurationTest {
    ...
    public void testConfigGood() {
        ...
        org.junit.Assert.assertEquals("test", Configuration.get().getKafkaProducer().clientId);
        ...
        org.junit.Assert.assertEquals("testgroup1", Configuration.get().getKafkaConsumers().get(0).groupId);
        org.junit.Assert.assertEquals("testgroup1", Configuration.get().getKafkaConsumers().get(0).groupId);
    }
